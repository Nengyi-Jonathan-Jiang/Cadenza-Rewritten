...
public class AimUtil {
    ...
    public static Rotation2d getPoseOffset(Translation2d targetTranslation) {
        ...
        Rotation2d heading = SubsystemManager.getSwerveDrive().getOrientation();
    ...
    public static ShooterSetpoint getShooterSetpoint() {
        ...
        angle -= Controls.DriverControls.getSwerveForwardAxis() * 0.1;
        speed -= Controls.DriverControls.getSwerveForwardAxis() * 0.1;
        return new ShooterSetpoint(angle, speed);
    }
}